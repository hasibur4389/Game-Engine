...
class ColorSeparatorFilter: NSObject{
...
//    var time: Float = 0
    ...
    func createVertices(){
       ...
       vertices = [
            ...
            Vertex(position: float3(1, -1, 0), color: float4(0, 0, 1, 1), texure: float2(1, 1))
            ]// Bottom
...
extension ColorSeparatorFilter: MTKViewDelegate{
...
extension ColorSeparatorFilter: Texturable {
